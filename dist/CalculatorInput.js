...
function propsToState(props) {
    ...
    return {
        value: props.value,
        text: (!!value || value === 0) ? utils_1.formatNumber(value, props.decimalSeparator, props.thousandSeparator) : '',
...
var CalculatorInput = /** @class */ (function (_super) {
    ...
    CalculatorInput.prototype.componentDidUpdate = function (prevProps) {
        var _a = this.props, value = _a.value, decimalSeparator = _a.decimalSeparator, thousandSeparator = _a.thousandSeparator;
        if (value != prevProps.value) {
            this.setState({ value: value, text: (!!value || value === 0) ? utils_1.formatNumber(value, decimalSeparator, thousandSeparator) : '' });
        }
        return null;
    };
    ...
    CalculatorInput.prototype.renderTextField = function () {
        var _a = this.props, fieldContainerStyle = _a.fieldContainerStyle, fieldTextStyle = _a.fieldTextStyle, fieldDisabledContainerStyle = _a.fieldDisabledContainerStyle, fieldDisabledTextStyle = _a.fieldDisabledTextStyle, prefix = _a.prefix, suffix = _a.suffix, placeholder = _a.placeholder;
    ...
    CalculatorInput.prototype.renderCalulatorModal = function () {
        ...
        }); }} {...this.props} value={this.state.value ? this.state.value : 0} height={height} width={width} style={style}/>
          </react_native_1.View>
    ...
    CalculatorInput.defaultProps = __assign({}, interface_1.DefaultCommonProps, { suffix: '', prefix: '', placeholder: '' });
